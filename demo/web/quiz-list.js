var quiz_list = [
	{ /* 0 */
		...
		"hints": [
			...
			"Hmmm... Can I <a href=\"#\">search it</a> on the Internet?"
		],
	...
	{ /* 1 */
		...
		"hints": [
			...
			"Wait... Can I <a href=\"#\">search it</a> on the Internet?"
		],
	...
	{ /* 4 */
		...
		"hints": [
			...
			"Is that possible to <a href=\"#\">search it</a> on the Internet?"
		],
	...
	{ /* 5 */
		...
		"hints": [
			...
			"Or if it is possible to <a href=\"#\">search the answer</a> on the Internet?"
		],
		"search":  "cone, $z=\\sqrt{x^2+y^2}$, plane, $z=1+y$"
	},
	{ /* 6 */
		"Q": "What is the value of [imath]\\lim_{n\\to\\infty}e^{-n}\\sum_{k=0}^{n}\\frac{n^k}{k!}[/imath] ?",
		"hints": [
			"Where do I start?",
		...
		"search": "$\\lim_{n\\to\\infty}e^{-n}\\sum_{k=0}^{n}\\frac{n^k}{k!}$, value"
	},
	{ /* 7 */
		...
		"hints": [
			...
			"OKay... Let's see if I can <a href=\"#\">search this question</a> on the Internet?"
		],
